...
# 수학 점수의 평균값을 구해라
# 결측치인 값을 수학점수의 평균으로 대체
# ifelse()함수를 이용하여 결측치에 수학점수의 평균값을 대입

MM=mean(exam$math,na.rm=T)
ifelse(is.na(exam$math),MM,exam$math)->exam$math
exam
...
# gender가 1과2 아니면 결측치로 변경

ifelse(outlier$gender!=1 & outlier$gender!=2,NA,outlier$gender)->outlier$gender
